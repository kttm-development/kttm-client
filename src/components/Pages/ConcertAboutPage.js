        ...
        if(this.props.contacts){
            if(!this.props.loggedIn){
                ...
                let createContactEmail=
                    `mailto:${this.props.contacts[0].email}?subject=${this.props.attraction} is coming to town&body=Hi,%20%0D%0A%20%0D%0AI found this concert and thought you may like it.  Details are:%20%0D%0A%20%0D%0AThe "${this.props.name}" event will be held on ${this.props.date} at ${this.props.venue} in ${this.props.city}, ${this.props.state}.  It will feature ${this.props.attraction} as the main event.  The event will start at ${this.props.time}.%20%0D%0A%20%0D%0AA link to buy tickets can be found at ${this.props.url}.%20%0D%0A%20%0D%0AThis has been an automated message generated by ConcertConnect.  Thanks and keep rockin!%20%0D%0A%20%0D%0Ahttps://concertconnect-client.herokuapp.com&bcc=${listOfEmails}`
                ...
                let createContactEmail=
                    `mailto:?subject=${this.props.attraction} is coming to town&body=Hi,%20%0D%0A%20%0D%0AI found this concert and thought you may like it.  Details are:%20%0D%0A%20%0D%0AThe "${this.props.name}" event will be held on ${this.props.date} at ${this.props.venue} in ${this.props.city}, ${this.props.state}.  It will feature ${this.props.attraction} as the main event.  The event will start at ${this.props.time}.%20%0D%0A%20%0D%0AA link to buy tickets can be found at ${this.props.url}.%20%0D%0A%20%0D%0AThis has been an automated message generated by ConcertConnect.  Thanks and keep rockin!%20%0D%0A%20%0D%0Ahttps://concertconnect-client.herokuapp.com`
